...
import { SiTailwindcss, SiNextdotjs, SiRedux, SiMongodb, SiExpress } from "react-icons/si";
...
const about = {
  ...
  info: [
    {
      fildName: "Name",
      fieldValue: "Abdullah al rafi",
    },
    {
      fildName: "Phone",
      fieldValue: "+880 1768899941",
    },
    {
      fildName: "Experience",
      fieldValue: "2+ years",
    ...
    {
      fildName: "email",
      fieldValue: "abdullah116632@gmail.com",
    },
    {
      fildName: "Freelance",
                        ...
                        <TooltipProvider delayDuration={100}>
                          <Tooltip>
                            <TooltipTrigger className="w-full h-[150px] bg-[#232329] rounded-xl flex justify-center items-center group">
                              <div className="text-6xl group-hover:text-accent translate-all duration-300">
                                {skill.icon}
                              </div>
                            </TooltipTrigger>
                            <TooltipContent>
